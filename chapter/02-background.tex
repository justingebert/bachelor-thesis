...
\begin{itemize}
    ...
    \item \textbf{Agentless approaches} focus on simplicity and efficiency, reducing complex multi-agent coordination while maintaining effectiveness \cite{xiaAgentlessDemystifyingLLMbased2024, puvvadiCodingAgentsComprehensive2025}. These approaches provide clear guardrails for LLMs, improving transparency. The three-step approach (localization, repair, validation) of Agentless approaches achieves promising results efficiently \cite{xiaAgentlessDemystifyingLLMbased2024, mengEmpiricalStudyLLMbased2024}.
\end{itemize}

Popular LLMs for APR include ChatGPT, Codex, CodeLlama, DeepSeek-Coder, and CodeT5 \cite{houLargeLanguageModels2024, yinThinkRepairSelfDirectedAutomated2024, anandComprehensiveSurveyAIDriven2024}. Despite significant advancements, state-of-the-art APR systems still face challenges like complexity, limited transparency, high computational costs, and difficulties integrating into real-world workflows \cite{xiaAgentlessDemystifyingLLMbased2024, puvvadiCodingAgentsComprehensive2025, houLargeLanguageModels2024}.

\subsection{APR Benchmarks}

Popular LLMs for the mentioned APR techniques include ChatGPT, Codex, CodeLlama, DeepSeek-Coder, and CodeT5 \cite{houLargeLanguageModels2024, yinThinkRepairSelfDirectedAutomated2024, anandComprehensiveSurveyAIDriven2024}. Despite the significant advancements that come with LLMs, state-of-the-art APR systems still face challenges and limitations. Existing systems suffer from complexity with limited transparency and control over the bug-fixing process \cite{xiaAgentlessDemystifyingLLMbased2024, puvvadiCodingAgentsComprehensive2025, houLargeLanguageModels2024}. Additionally, the repair process can be computationally intensive and time-consuming, making it expensive \cite{sobaniaAnalysisAutomaticBug2023, puvvadiCodingAgentsComprehensive2025}. A major barrier for practical adoption comes from the fact, that APR systems are designed and evaluated in controlled environments. As a result, integration into real-world software development workflows and projects has not yet been fully achieved \cite{meemExploringExperiencesAutomated2024, puvvadiCodingAgentsComprehensive2025}.
