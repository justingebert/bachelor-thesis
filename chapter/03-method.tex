...
To answer these questions, we streamlined the process into three phases: preparation, implementation/usage, and evaluation. The integration itself is carried out during the implementation phase. The process is visualized below in Figure \ref{fig:method-overview}.
