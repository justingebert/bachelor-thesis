...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.9\textwidth]{images/figures/triggers_placeholder.png}
%     \caption{Workflow triggers for APR system}
%     \label{fig:triggers}
% \end{figure}

% \begin{lstlisting}[caption={Filtered issues log excerpt}, label={lst:filtered-issues}]
% [INFO] Filtered issues: #12, #15, #18
% [INFO] Only issues with label 'to_fix' are processed.
% \end{lstlisting}

% \begin{lstlisting}[caption={Code checkout log excerpt}, label={fig:code-checkout}]
% [INFO] Checking out repository: github.com/example/repo
% [INFO] Checked out branch: main
% \end{lstlisting}

% \begin{lstlisting}[caption={Bug localization log excerpt}, label={lst:loc}]
% [INFO] Localization result: ["src/module1.py", "src/utils.py"]
% \end{lstlisting}

% \begin{lstlisting}[caption={Fix generation log excerpt}, label={fig:fix}]
% [INFO] Generated fix for src/module1.py
% [INFO] No changes needed for src/utils.py
% \end{lstlisting}

% \begin{lstlisting}[caption={Change validation log excerpt}, label={fig:validation}]
% [INFO] Running Black formatter...
% [INFO] Running flake8 linter...
% [INFO] No syntax errors found.
% \end{lstlisting}

% \begin{lstlisting}[caption={Iterative patch generation log excerpt}, label={fig:retry}]
% [INFO] Test failed, retrying fix (attempt 2/3)
% [INFO] Feedback added to prompt for next attempt.
% \end{lstlisting}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{images/figures/branch_commit_placeholder.png}
%     \caption{Branch and commit created for bugfix}
%     \label{fig:branch-commit}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{images/figures/pr_report_placeholder.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{images/figures/comment_placeholder.png}
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{images/figures/logs_artifacts_placeholder.png}
%     \caption{Logs and metrics artifact from workflow run}
%     \label{fig:logs-artifacts}
% \end{figure}

% \begin{lstlisting}[caption={Docker container runtime log excerpt}, label={lst:docker-log}]
% [INFO] Starting APR Core in Docker container...
% [INFO] Container ID: 123abc456def
% \end{lstlisting}

% \begin{lstlisting}[caption={System configuration log excerpt 1}, label={lst:log1}]
% [INFO] Loaded configuration from bugfix.yml
% [INFO] Max attempts set to 3
% \end{lstlisting}

% \begin{lstlisting}[caption={System configuration log excerpt 2}, label={lst:log2}]
...
% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{images/figures/repo1_run_placeholder.png}
%     \caption{APR run on repository 1}
%     \label{fig:repo1-run}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{images/figures/repo2_run_placeholder.png}
%     \caption{APR run on repository 2}
%     \label{fig:repo2-run}
% \end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=0.7\textwidth]{images/figures/metrics_placeholder.png}
%     \caption{Metrics artifact from workflow run}
%     \label{fig:metrics}
% \end{figure}
